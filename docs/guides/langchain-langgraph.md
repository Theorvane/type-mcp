...
> **Release boundary:** `@theorvane/type-mcp/langchain` is available in the published `@theorvane/type-mcp@0.2.0` package. It is tools-only; LangGraph remains a consumer-owned composition choice.
