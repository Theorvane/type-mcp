...
> **Published boundary:** `@theorvane/type-mcp/langchain` is part of the published `@theorvane/type-mcp@0.4.0` package. It is tools-only; LangGraph remains a consumer-owned composition choice.
