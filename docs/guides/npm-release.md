...
3. Finish and verify the compiler, resolver, stdio, and HTTP adapter work. The current package is not a release candidate: `createMcpServer()` and `createMcpHandler()` still throw placeholder errors.
